...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem() {
    this.climberLift = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.climberLift);
    this.climberRelease = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.climberRelease);
    this.climberLock = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.climberLock);
