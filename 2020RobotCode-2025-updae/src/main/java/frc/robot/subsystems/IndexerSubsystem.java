...
public class IndexerSubsystem extends SubsystemBase {
  ...
  public IndexerSubsystem(TurretSubsystem tSubsystem) {
    ...
    this.indexingMotor = new SparkMax(Constants.indexingSparkMax, MotorType.kBrushless);
    SparkMaxConfig indexerConfig = new SparkMaxConfig();
    indexerConfig.smartCurrentLimit(Constants.miniNeoSafeAmps);
    this.indexingMotor.configure(indexerConfig, ResetMode.kNoResetSafeParameters, PersistMode.kNoPersistParameters);
    this.intakeMotor = new Spark(Constants.intakeSpark);
    this.intakeExtension = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.intakeExtension);
  ...
  private void updateShotInProgress(){
    ...
    this.shotInProgress = !this.shotInProgressTimer.hasElapsed(Constants.shotInProgressTime);
