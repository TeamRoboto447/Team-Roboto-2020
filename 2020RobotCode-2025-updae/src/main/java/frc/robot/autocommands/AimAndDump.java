...
public class AimAndDump extends Command {
  ...
  public AimAndDump(TurretSubsystem tSubsystem, IndexerSubsystem iSubsystem, boolean scanRight, double scanSpeed, double maxTime,
      int ballsToShoot) {
